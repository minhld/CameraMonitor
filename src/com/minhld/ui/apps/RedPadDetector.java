	...
	public void run() {
		...
		mainFrame.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int response = JOptionPane.showConfirmDialog(RedPadDetector.this.mainFrame, 
	...
	private JToolBar buildToolBar() {
		...
		findPadBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				RedPadDetector.this.isAuto = !RedPadDetector.this.isAuto;
				controlInfoText.setText("AUTOMATION IS " + (RedPadDetector.this.isAuto ? "SET" : "CLEARED"));
				findPadBtn.setText(RedPadDetector.this.isAuto ? "Stop Finding" : "Find Pad");
		...
		initMovingBtn.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				RedPadDetector.this.isMovingNode = !RedPadDetector.this.isMovingNode;
				// controlInfoText.setText("AUTOMATION IS " + (RosAutoRed.this.isMovingNode ? "SET" : "CLEARED"));
				initMovingBtn.setText(RedPadDetector.this.isMovingNode ? "Stop Node" : "Start Moving Node");
...
//		slidesPanel.setBorder(new EmptyBorder(15, 15, 15, 15));
		...
		buttonPanel.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (RedPadDetector.this.isServerInUsed) {
					RedPadDetector.this.buttonPanel.requestFocusInWindow();
				}
			}
			...
			public void run() {
				...
				ROSUtils.execute(graphCameraName, new CameraNode(new CameraNode.ImageListener() {
					...
					public void imageArrived(Image image) {
						...
						RedPadDetector.this.processTimeLabel.setText("Displaying Time: " + drawTime + "ms | " +  
						...
						RedPadDetector.this.topicInfoText.setText("Distance: " + AppUtils.getNumberFormat(objectDistance) + "ft(s)\n" + 
	...
	private void setFindingPadStatus(boolean isAuto) {
		RedPadDetector.this.isAuto = isAuto;
		controlInfoText.setText("AUTOMATION IS " + (RedPadDetector.this.isAuto ? "SET" : "CLEARED"));
		findPadBtn.setText(RedPadDetector.this.isAuto ? "Stop Finding" : "Find Pad");
