...
/**
 * this supports rotating and finding the proper direction of the
 * wheelchair with the charging pad
 * 
 * @author lee
 *
 */
public class RotMoveInstructor extends AbstractNodeMain {
	...
	public RotMoveInstructor() {
		this.publisherName = ROSUtils.getNodeName(RotMoveInstructor.moveTopicTitle);
	}
